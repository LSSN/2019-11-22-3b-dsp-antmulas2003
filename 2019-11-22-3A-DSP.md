...
```
Il teorema del campionamento serve per trovare la frequenza di campionamento, che è la quantità di misurazione attraverso l'unità di tempo, attraverso fc=2fmax
```
